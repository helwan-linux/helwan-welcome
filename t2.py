...
class WelcomeApp(QWidget):
    def __init__(self):
        ...
        self.setGeometry(100, 100, 600, 500)  # تقليل حجم النافذة الافتراضي
    ...
    def load_logo(self):
        try:
            ...
            if os.path.exists(logo_path):
                ...
                if not logo.isNull():
                    # تصغير حجم اللوجو هنا
                    scaled_logo = logo.scaledToWidth(150, Qt.SmoothTransformation)
                    return scaled_logo
                else:
    ...
    def init_ui(self):
        ...
        layout.setAlignment(Qt.AlignCenter) # توسيط العناصر في النافذة
        ...
        self.greeting_label.setStyleSheet("font-size: 14px; margin-top: 15px; margin-bottom: 20px;") # تحسين التنسيق
        layout.addWidget(self.greeting_label)

        self.controls_layout = QVBoxLayout() # تجميع عناصر التحكم
        self.controls_layout.setSpacing(10) # إضافة مساحة بين العناصر
        layout.addLayout(self.controls_layout)

        language_hbox = QHBoxLayout() # صف لتضمين تسمية وقائمة اللغة
        self.language_label_app = QLabel(_("Application Language:"))
        language_hbox.addWidget(self.language_label_app)
        ...
        system_language_hbox = QHBoxLayout() # صف لتضمين تسمية وقائمة لغة النظام
        system_language_label = QLabel(_("System Language:"))
        system_language_hbox.addWidget(system_language_label)
