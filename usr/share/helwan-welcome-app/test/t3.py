...
def load_translation(language_code):
    ...
    try:
        ...
        translation = gettext.translation('base', localedir=locale_path, languages=['en'], fallback=True)
        translation.install()
        return translation.gettext
...
class WelcomeApp(QWidget):
    ...
    def init_ui(self):
        ...
        docs_row.addWidget(self.create_button(_("Open YouTube Channel"), lambda: self.open_url("https://www.youtube.com/channel/UCKlFDMjrzkVFzw-erYKVibQ")))
    ...
    def apply_system_language(self):
        ...
        self.run_terminal_cmd(f"sudo localectl set-locale LANG={lang}")
