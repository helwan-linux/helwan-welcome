...
def load_translation(language_code):
    ...
    try:
        ...
        try:
            ...
            # If even English translation is not found, fallback to using original strings
            return lambda s: s
...
class WelcomeApp(QWidget):
    ...
    def init_ui(self):
        ...
        docs_row.addWidget(self.create_button(_("Open YouTube Channel"), lambda: self.open_url("https://www.youtube.com/your_channel_here"))) # Please replace with a valid URL
